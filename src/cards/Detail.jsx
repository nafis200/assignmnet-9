    ...
    <div className="mt-20">
      <section className="lg:flex lg:gap-4">
        ...
        <div className=" space-y-2 flex-1">
          ...
          <p className="">
            <span className="text-2xl font-bold mr-5 mt-4 mb-5 ml-10 lg:ml-0">
              Facilities:{" "}
            </span>{" "}
            <span className=" font-extralight gap-5 items-center mt-1 space-y-4">
              {facilities.map((data) => (
                <Facilitiesdetails data={data}></Facilitiesdetails>
              ))}
            </span>
          </p>
          ...
          <div className=" space-y-3">
            ...
            <p className="flex justify-start ml-10 lg:ml-0">
              ...
              <h2 className="font-bold flex items-center gap-2">
                ...
                <span>
                  {" "}
                  <FaLandmark className="text-3xl"></FaLandmark>{" "}
                </span>{" "}
                {area}{" "}
              </h2>{" "}
            </p>
